...
<div class="d-flex justify-content-between  mt-4 ">
    <div class="fs-5">Bienvenido, <?php echo e($userlogged->name); ?> <a href="/editar/<?php echo e($userlogged->id); ?>"><i class="bi bi-pencil"></i></a></div>
      ...
      <?php 
        foreach($todos as $todo){
          ...
          <tr >
            ...
            <form method="POST" action="/editarTodo/<?php echo e($todo["id"]); ?>"> <?php echo csrf_field(); ?><button type="submit" class="btn btn-outline-warning" >Editar</button></form>
            <form method="POST" action="/eliminar/<?php echo e($todo["id"]); ?>"> <?php echo csrf_field(); ?><button type="submit" class="btn btn-outline-danger" onclick="return confirm('¿Estás seguro de que deseas eliminar este Todo?')">Eliminar</button></form>
            <form method="POST" action="/cambiarEstado/<?php echo e($todo["id"]); ?>"> <?php echo csrf_field(); ?> <button type="submit" class="btn <?php echo e($todo["estado"] ? "btn-outline-danger" : "btn-outline-success"); ?>" class=" " ><?php echo e($todo["estado"] ? "Desmarcar" : "Marcar como completado"); ?></button></form>
          </td>
...
</html><?php /**PATH C:\Users\franr\Desktop\Proyecto-Laravel2\resources\views/dashboard.blade.php ENDPATH**/ ?>